...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    },
    {
      ...
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
          <path fillRule="evenodd" d="M2.166 4.999A11.854 11.854 0 001 8.018 59.925 59.925 0 001 16.35c.124.95.722 1.798 1.635 2.205.436.194.895.294 1.365.298H16c.47-.004.929-.104 1.365-.298.913-.407 1.511-1.255 1.635-2.205A59.925 59.925 0 0019 8.018a11.854 11.854 0 00-1.166-3.019C17.262 4.089 16.5 3.5 15.634 3.5H4.366C3.5 3.5 2.738 4.09 2.166 5z" clipRule="evenodd"/>
          <path d="M8.23 14.846l4.482-2.598L8.23 9.65v5.196z"/>
        </svg>
      )
    },
    {
      ...
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
          <path fillRule="evenodd" d="M12.017 0H7.983C3.58 0 0 3.58 0 7.983v4.034C0 16.42 3.58 20 7.983 20h4.034C16.42 20 20 16.42 20 12.017V7.983C20 3.58 16.42 0 12.017 0zM18 12.017c0 3.312-2.688 6-6 6H7.983c-3.312 0-6-2.688-6-6V7.983c0-3.312 2.688-6 6-6h4.034c3.312 0 6 2.688 6 6v4.034z" clipRule="evenodd"/>
          <path d="M9.982 4.819c-2.797 0-5.064 2.267-5.064 5.064s2.267 5.064 5.064 5.064 5.064-2.267 5.064-5.064-2.267-5.064-5.064-5.064zM9.982 13.084a3.2 3.2 0 110-6.4 3.2 3.2 0 010 6.4zM15.191 4.15a1.2 1.2 0 11-2.4 0 1.2 1.2 0 012.4 0z"/>
        </svg>
      )
    }
  ];
  ...
  return (
    <footer className="relative bg-[#0A0A0B] border-t border-slate-800/50">
      {/* Subtle Grid Pattern */}
